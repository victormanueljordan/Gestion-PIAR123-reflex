# Importaciones necesarias para el manejo de estado en Reflex
import reflex as rx
from typing import Literal

# Definición de tipo literal para las páginas disponibles en la aplicación
# Esto garantiza que solo se puedan usar nombres de página válidos
...
class AppState(rx.State):
    ...
    # Página actualmente activa - determina qué contenido se muestra
    active_page: Page = "Dashboard"
    
    # Estado del sidebar - controla si está visible u oculto
