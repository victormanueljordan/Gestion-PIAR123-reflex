import reflex as rx
from app.states.settings_state import SettingsState, Sede
...
def settings_page() -> rx.Component:
    ...
    return rx.el.div(
        ...
        accordion_item(
            "2. Año lectivo y periodos",
            placeholder_content("Año lectivo"),
            "ano_lectivo",
        ),
        accordion_item(
            "3. Grados, cursos y grupos", placeholder_content("Grados"), "grados"
        ),
        accordion_item("4. Áreas y asignaturas", placeholder_content("Áreas"), "areas"),
        accordion_item(
            "5. Docentes y roles", placeholder_content("Docentes"), "docentes"
        ),
        accordion_item(
            "6. Catálogos pedagógicos (PIAR)",
            placeholder_content("Catálogos"),
            "catalogos",
        ),
        accordion_item(
